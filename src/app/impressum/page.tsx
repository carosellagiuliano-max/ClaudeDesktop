      ...
      <div className="container-wide max-w-3xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-xl font-semibold">Angaben gemäss Art. 3 UWG</h2>
          ...
          {/* Management */}
          <section className="mb-8">
            <h2 className="mb-4 text-xl font-semibold">Geschäftsführung</h2>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              ...
              auf der Website gehören ausschliesslich der Firma {companyInfo.legalName} oder den
