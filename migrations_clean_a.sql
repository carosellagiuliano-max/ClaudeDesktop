-- ============================================
-- SCHNITTWERK Clean Migration - PART A
-- All Tables, Functions, Triggers, Indexes, RLS
-- ============================================

-- ========== FROM: 00001_enums.sql ==========
-- ============================================
...
-- REMOVED: gin_trgm_ops index (requires pg_trgm extension)
...
-- ========== FROM: 00015_contact_inquiries.sql ==========
-- ============================================
...
-- ========== FROM: 00016_booking_enhancements.sql ==========
-- ============================================
-- SCHNITTWERK Database Schema
...
-- ========== FROM: 00018_payment_enhancements.sql ==========
-- ============================================
-- SCHNITTWERK Database Schema
...
-- ========== FROM: 00020_staff_enhancements.sql ==========
-- ============================================
-- STAFF BLOCKS TABLE
...
CREATE POLICY "Managers can manage skills"
  ...
  USING (
    EXISTS (
      ...
      JOIN user_roles ur ON s.profile_id = ur.profile_id AND s.salon_id = ur.salon_id
...
-- ========== FROM: 00023_marketing_feedback.sql ==========
-- ============================================
...
-- ========== FROM: 00024_push_subscriptions.sql ==========
-- ============================================
...
CREATE TABLE IF NOT EXISTS deposit_policies (
  ...
  -- REMOVED: Invalid UNIQUE WHERE constraint
